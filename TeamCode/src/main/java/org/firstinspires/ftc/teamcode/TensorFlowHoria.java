...
@Autonomous(name = "TensorFlowHoria")
//@Disabled
public class TensorFlowHoria extends LinearOpMode {
    ...
    public void runEncoders (int distance, double power, double timeoutS) {
        ...
        while ( (stangaFata.isBusy() && dreaptaFata.isBusy() ) && opModeIsActive() && (runtime.seconds() < timeoutS))
        {
            //Wait for the motors to run
            telemetry.addData("left1 pos: ", stangaFata.getCurrentPosition());
            telemetry.addData("right1 pos: ", dreaptaFata.getCurrentPosition());
            telemetry.update();
        }
    ...
    {
        runEncoders(500, 0.1, 15);
        rotate(0.25,1, 45);
        sleep(200);
        runEncoders(500, 0.1, 2);
//        sleep(200);
//        rotate(0.1, -1, -45);
//        sleep(200);
...
//        runEncoders(200, 0.1,10);
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            runtime.reset();
            while (goldPos == -1 && tfod != null && runtime.seconds() < 2) {
